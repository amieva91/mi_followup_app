...
DEFAULT_WIDGETS = [
    ...
    {'id': 'real_estate', 'name': 'Inmuebles', 'icon': '🏠', 'enabled': True, 'position': 8},
    {'id': 'debt', 'name': 'Deudas', 'icon': '📋', 'enabled': True, 'position': 9},
    {'id': 'income_expense', 'name': 'Ingresos/Gastos Mes', 'icon': '💵', 'enabled': True, 'position': 10},
    {'id': 'savings_rate', 'name': 'Tasa de Ahorro', 'icon': '📉', 'enabled': True, 'position': 11},
    {'id': 'top_expenses', 'name': 'Top Gastos Mes', 'icon': '🔥', 'enabled': True, 'position': 12},
    {'id': 'upcoming_payments', 'name': 'Próximos Pagos', 'icon': '📅', 'enabled': True, 'position': 13},
    {'id': 'investments_summary', 'name': 'Rentabilidad Inversiones', 'icon': '📈', 'enabled': True, 'position': 14},
    {'id': 'recent_transactions', 'name': 'Últimos Movimientos', 'icon': '🔄', 'enabled': True, 'position': 15},
