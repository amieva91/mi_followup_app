...
- **Implementado (v1 motor):** `app/services/watchlist_bank_valuation.py` + rama `banks` en `WatchlistMetricsService.update_all_metrics`. Umbrales F_bank por defecto según tablas §13.4; inputs en modal edición watchlist.
