#!/usr/bin/env python3
"""
Script para diagnosticar la sección de Depósitos y Retiradas de IBKR
"""
...
print("\n" + "="*80)
print("DIAGNÓSTICO: DEPÓSITOS Y RETIRADAS DE IBKR")
print("="*80 + "\n")
...
for csv_file in csv_files:
    ...
    with open(csv_file, 'r', encoding='utf-8') as f:
        ...
        for i, row in enumerate(reader, 1):
            ...
            if 'Depósitos y retiradas' in section_name or 'Deposits & Withdrawals' in section_name:
                in_section = True
            ...
            # Salir de la sección
            if in_section and section_name and section_name not in ['Depósitos y retiradas', 'Deposits & Withdrawals']:
                break
            ...
            if in_section and row_type == 'Data':
                ...
                if count <= 5:  # Mostrar solo los primeros 5 ejemplos
                    ...
                    # Mostrar raw
                    print("  Raw (primeras 10 columnas):")
                    for idx, val in enumerate(data_row[:10]):
                        print(f"    [{idx:2}] {val}")
                    ...
                    if headers and len(data_row) >= len(headers):
                        ...
                        print(f"    Fecha de liquidación: {row_dict.get('Fecha de liquidación', row_dict.get('Settle Date', 'N/A'))}")
